...
export class JSEncryptRSAKey extends RSAKey {
     ...
     * @constructor
     */
    constructor(key?:string|IKeySeed) {
        super();
     ...
     * @private
     */
    private parsePropertiesFrom(obj:IKeySeed) {
        this.n = obj.n;
        this.e = obj.e;
 ...
 * @private
 */
function  hasPublicKeyProperty(obj:object) {
    obj = obj || {};
    return (
 ...
 * @private
 */
function hasPrivateKeyProperty(obj:object) {
    obj = obj || {};
    return (
        obj.hasOwnProperty("n") &&
        obj.hasOwnProperty("e") &&
